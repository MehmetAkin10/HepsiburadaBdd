...
public class StepImplementation extends BaseTest {
    ...
    @Step("<key> xpath'li elementin text degeri bir dizine at")
    ...
    @Step("<key> li element gorunur olana kadar bekle")
    public void gorunurbekleKey(String key) {
        WebDriverWait wait = new WebDriverWait(appiumDriver, 20);
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(key)));
    }

    @Step("<key>  xpath'li elementin oldugu kontrol edilir")
    public void checkElementKey(String key) {
        Assert.assertTrue("Elementi gördü", appiumDriver.findElement(By.xpath(key)).isDisplayed());
        logger.info("Elementi gördü");
    }
